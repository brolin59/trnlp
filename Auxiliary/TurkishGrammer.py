...
def wordtoten(word):
    ...
    translate_wtonum_0 = str.maketrans(upper_quiet, len(upper_quiet) * '0')
    translate_wtonum_1 = str.maketrans(upper_vowel, len(upper_vowel) * '1')
    word = (word.translate(translate_wtonum_1)).translate(translate_wtonum_0)
...
def to_lower(word):
    translate_utol = str.maketrans(All_upper_char, All_lower_char)
    tolower_text = (word.translate(translate_utol)).lower()
...
# Gelen string(yazı) veriyi küçük harfe çevirir.
def to_upper(word):
    translate_utol = str.maketrans(All_lower_char, All_upper_char)
    toupper_text = (word.translate(translate_utol)).upper()
