...
isim_cekim_ekleri = [['1', '0', 'lEr', 'Çokluk Eki', '(l[ae]r)', (-1, 2, 4, 6, 8, 11, 14, 17, 20, 21, 23, 26, 28), 2],
                     ...
                     ['21', '2', 'DE', 'Bulunma Hal Eki', '([dt][ae])', (-1, 27), 0],
                     ['22', '2', 'XDE', 'Bulunma Hal Eki', '(n[dt][ae])', (27,), 1],
                     ['23', '2', 'DEn', 'Ayrılma/Uzaklaşma Hal Eki', '([dt][ae]n)', (-1,), 0],
...
fiil_cekim_ekleri = [['1', '0', 'DU', 'Bilinen Geçmiş Zaman', '([dt][ıiuü])', (-1, 24, 26, 30, 32, 33), 2],
                     ...
                     ['12', '1', 'XE', 'İstek Kipi', '(y[ae])', (-1, 22, 25, 29, 31, 33), 0],
                     ['13', '1', 'E', 'İstek Kipi', '([ae])', (-1, 22, 25, 29, 31, 33), 1],
                     ...
                     ['34', '3', 'mEz', 'Olumsuzluk Eki', '(m[ea]z)', (-1,), 2]]
